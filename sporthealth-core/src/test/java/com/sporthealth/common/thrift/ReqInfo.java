...
public class ReqInfo implements org.apache.thrift.TBase<ReqInfo, ReqInfo._Fields>, java.io.Serializable, Cloneable, Comparable<ReqInfo> {
  ...
  public Subscriber subscriber; // required
  ...
  static {
    ...
    tmpMap.put(_Fields.SUBSCRIBER, new org.apache.thrift.meta_data.FieldMetaData("subscriber", org.apache.thrift.TFieldRequirementType.DEFAULT, 
        new org.apache.thrift.meta_data.StructMetaData(org.apache.thrift.protocol.TType.STRUCT, Subscriber.class)));
  ...
  public ReqInfo(ReqInfo other) {
    ...
    if (other.isSetSubscriber()) {
      this.subscriber = new Subscriber(other.subscriber);
    }
  }
  ...
  public ReqInfo setId(java.lang.String id) {
    this.id = id;
    return this;
  }
  ...
  public ReqInfo setSubscriber(Subscriber subscriber) {
    this.subscriber = subscriber;
    return this;
  }
  ...
  public int hashCode() {
    ...
    hashCode = hashCode * 8191 + ((isSetSubscriber()) ? 131071 : 524287);
    if (isSetSubscriber())
      hashCode = hashCode * 8191 + subscriber.hashCode();
  ...
  public int compareTo(ReqInfo other) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetSubscriber()).compareTo(other.isSetSubscriber());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetSubscriber()) {
  ...
  public java.lang.String toString() {
    java.lang.StringBuilder sb = new java.lang.StringBuilder("ReqInfo(");
    boolean first = true;
        ...
        switch (schemeField.id) {
          ...
          case 2: // SUBSCRIBER
            if (schemeField.type == org.apache.thrift.protocol.TType.STRUCT) {
              struct.subscriber = new Subscriber();
